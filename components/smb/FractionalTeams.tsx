...
export default function FractionalTeams() {
    return (
        <section className="py-16 px-4 md:px-8 bg-white">
            <div className="container mx-auto max-w-7xl bg-slate-50 rounded-[40px] p-8 md:p-16 overflow-hidden relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    {/* Left Column: Content */}
                    <div className="z-10">
                        <div className="mb-8">
                            <h3 className="text-slate-600 font-medium mb-4">
                                <span className="font-bold text-slate-900">AMAKA</span> Fractional Teams
                            </h3>
                            <h2 className="text-5xl md:text-6xl font-medium tracking-tight text-slate-900 leading-[1.1]">
                                Scale without <span className="font-serif italic text-blue-600">expensive</span>
                                <br />
                                <span className="font-serif italic text-blue-600">full-time hires</span>
                            </h2>
                        </div>
                    ...
                    <div className="relative h-[400px] lg:h-[600px] flex items-center justify-center">
                        ...
                        <div className="relative w-full h-full transform rotate-6 hover:rotate-0 transition-transform duration-700 ease-out">
                            <Image
