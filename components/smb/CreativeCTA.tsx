        ...
        <div className="relative bg-white rounded-[32px] overflow-hidden shadow-lg border border-gray-100 flex flex-col md:flex-row min-h-[400px]">
          ...
          <div className="flex-1 p-8 md:p-16 flex flex-col justify-center z-10 relative">
            <h2 className="text-4xl md:text-5xl font-medium text-black mb-6">
              Are you a{" "}
              <span className="font-serif italic text-np-orange">creative</span>
              ?
            </h2>
            <p className="text-gray-600 text-lg mb-8 max-w-md">
              Turn your creativity into income! Connect with brands, grow your
              audience, and get paid for your work.
            </p>
            <Link
              href="/news"
          ...
          {/* Image Side */}
          <div className="relative w-full md:w-1/2 min-h-[300px] md:min-h-full max-md:hidden">
            <Image
