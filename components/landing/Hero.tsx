...
export default function Hero() {
  ...
  return (
    <section className="w-full h-screen bg-black text-white flex-center px-6 py-20 md:px-12">
      ...
      */}
      <div className="w-full flex flex-col gap-4 items-start text-left md:items-center md:text-center  max-sm:pt-16 md:mt-20">
        ...
        <div className="overflow-hidden">
          <h1 className="hero-element max-w-3xl text-3xl sm:text-4xl font-bold tracking-tight leading-[1.1]">
        ...
        {/* Subtext */}
        <div className="overflow-hidden">
          <p className="hero-element text-md md:text-xl font-light leading-relaxed max-w-3xl">
        ...
        <div className="overflow-hidden p-1">
          {" "}
          {/* Added padding to avoid clipping shadow/outline if any */}
          <Link
            onClick={openModal}
            href="#"
