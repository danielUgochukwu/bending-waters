...
export default function PageHero({
    ...
    return (
        <section
            ref={containerRef}
            className="relative bg-[#171717] flex flex-col items-center -mt-16 overflow-hidden max-sm:px-4 text-white"
        >
            {/* Background SVG */}
            <svg
                ref={bgRef}
            ...
            <p
                ref={textRef}
                className="text-center text-sm md:text-base max-w-lg mt-2 text-gray-300"
            >
                {description}
            </p>
